...
Cobrowse = {
  ...
  addStyle: function() {
    Cobrowse.stylesheet = "assets/css/style.css";
    if ($co("#cobrowser").attr("data-stylesheet")) { Cobrowse.stylesheet = $co("#cobrowser").data("stylesheet"); }
  ...
  init: function() {
    if (btoa(window.location.hostname) == $co("#cobrowser").data("api-key")) {
      Cobrowse.addStyle();
      Cobrowse.createCta();
  ...
  connect: function() {
    ...
    if ($co("#cobrowser").attr("data-url") && $co("#cobrowser").attr("data-url") != document.URL) {
  ...
  activate: function(code) {
    if (typeof($co.cookie("cobrowse_mouse_id")) != "undefined") {
      Cobrowse.mouse.id = $co.cookie("cobrowse_mouse_id");
    } else { 
      Cobrowse.mouse.id = Cobrowse.uuid();
      $co.cookie("cobrowse_mouse_id", Cobrowse.mouse.id);
    }
